...
bool lIdentical=isIsomorphic(root1->left,root2->left);
bool rIdentical=isIsomorphic(root1->right,root2->right);
bool lMirror=isIsomorphic(root1->left,root2->right);
bool rMirror=isIsomorphic(root1->right,root2->left);
if((lIdentical==true && rIdentical==true)||(lMirror==true||rMirror==true))
{
